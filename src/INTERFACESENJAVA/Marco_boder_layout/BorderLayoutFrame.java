package INTERFACESENJAVA.Marco_boder_layout;
...
public class BorderLayoutFrame extends JFrame implements ActionListener
{
    ...
    public BorderLayoutFrame()
    {
        ...
        // create objects JButton and register listeners for them
    ...
    {
        //checks the event source and dispatches the content pane of chordal manner
        ...
        layout.layoutContainer(getContentPane()); // distribute the content pane
    }
