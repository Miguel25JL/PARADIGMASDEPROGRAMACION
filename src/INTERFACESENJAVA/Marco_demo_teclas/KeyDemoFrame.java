package INTERFACESENJAVA.Marco_demo_teclas;
...
public class KeyDemoFrame extends JFrame implements KeyListener
{
    ...
    private JTextArea textArea; // text of area to display output
    ...
    public KeyDemoFrame()
    {
        ...
        add(textArea); // add area of text to JFrame
    ...
    {
        line2 = String.format("This key %s is an action key",
