package INTERFACESENJAVA.Marco_detalles_ratón;
...
public class MouseDetailsFrame extends JFrame
{
    ...
    // cconstructor sets String of title bar and registers component mouse listening
    ...
    private class MouseClickHandler extends MouseAdapter
    {
        ...
        public void mouseClicked(MouseEvent event)
        {
            ...
            statusBar.setText(details); // show statusBar message
        }
    }
