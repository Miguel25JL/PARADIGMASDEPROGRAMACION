package INTERFACESENJAVA.Marco_Botón;
...
public class ButtonFrame extends JFrame
{
    ...
    // ButtonFrame adds objects JButton to JFrame
    public ButtonFrame()
    {
        super("Buttons test");
        ...
        Icon bug1 = new ImageIcon(getClass().getResource("/IMAGENES/bug1.gif"));
        Icon bug2 = new ImageIcon(getClass().getResource("/IMAGENES/bug2.gif"));
        fancyJButton = new JButton("Fancy Button", bug1); // set image
        fancyJButton.setRolloverIcon(bug2); // set the image of substitutione
